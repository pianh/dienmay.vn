...
EOT;
    ...
    <section class="sheet padding-10mm">
        ...
        <table border="0" width="100%" cellspacing="0">
            <tbody>
                <tr>
                    <td align="center"><img src="/dienmay.vn/assets/backend/imgs/log.svg/" width="100px" height="100px" /></td>
                    <td align="center">
                        <b style="font-size: 2em;">Dienmay.vn - Tận tâm với khách hàng</b><br />
                        <small>Cung cấp các sản phẩm về điện thoại điện máy</small><br />
