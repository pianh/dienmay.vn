            ...
            <div class="col-md-10">
                ...
                <a href="create.php" class="btn btn-primary">Thêm mới</a>
                    ...
                    <?php foreach($data as $nsx): ?>
                        <tr>
                            <td><?= $nsx['nsx_ma']  ?>  </td>
                            <td><?php echo $nsx['nsx_ten']  ?></td>
                            <td>
                                <a href="edit.php?nsx_ma=<?= $nsx['nsx_ma']?>" class="btn btn-warning">Sửa</a>
                                <!-- <a href="delete.php?nsx_ma=<?= $nsx['nsx_ma']?>" class="btn btn-danger">Xóa</a> -->
                                <button type="button" class="btn btn-danger btnDelete" data-nsx_ma="<?= $nsx['nsx_ma'] ?>">
                                    Xóa
                                </button>
                                </form>
                            </td>
