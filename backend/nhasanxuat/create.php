    ...
    <div class="container-fluid pb-450">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <h2 class="text-center">Thêm mới nhà sản xuất</h2>
                <form name="frmCreate" id="frmCreate" method="post" action="">
                    Tên nhà sản xuất (*):
                    <br/>
                    <input type="text" name="nsx_ten" id="nsx_ten" class="form-control"/>
                    <br />
                ...
                if(isset($_POST['btnSave'])) {
                    ...
                    //2. chuẩn bị câu lệnh
                    $ten = htmlentities($_POST['nsx_ten']);
                    $sql = "INSERT INTO nhasanxuat(nsx_ten) VALUES ('$ten');";
                    //debug
                    var_dump($sql);
                    die;
