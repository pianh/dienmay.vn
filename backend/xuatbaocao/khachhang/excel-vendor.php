...
while ($item = mysqli_fetch_array($result)) {
    ...
    $sheet = $spreadsheet->getActiveSheet()
        ->setCellValue('A'.$currentContentRow, $item['kh_ten'])
        ->setCellValue('B'.$currentContentRow, $item['kh_diachi'])
        ->setCellValue('C'.$currentContentRow, $item['kh_dienthoai'])
        ->setCellValue('D'.$currentContentRow, $item['kh_email'])
        ->setCellValue('E'.$currentContentRow, $item['kh_namsinh'])
        ->setCellValue('F'.$currentContentRow, $item['kh_cmnd']);
